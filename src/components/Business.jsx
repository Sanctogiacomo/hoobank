...
const Business = () => {
  return (
    <section id='features' className={layout.section}>
      ...
      <p className={`${styles.paragraph} max-w-[490px] mt-5` }>With the right credit card, you can improve your financial life by building credit, earning rewards and saving money. But with hundreds of credit cards on the market.</p>
      <Button styles="mt-10"/>
      </div> 
